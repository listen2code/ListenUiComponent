...
val PureBlackOnBackground = Color(0xFFF0F0F0)
val PureBlackOnSurface = Color(0xFFFFFFFF)
val PureBlackOutline = Color(0xFF262626)
val PureBlackOutlineVariant = Color(0xFF1A1A1A)
